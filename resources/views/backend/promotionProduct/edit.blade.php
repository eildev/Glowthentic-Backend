                            ...
                            <select class="form-select product" id="product">
                                ...
                                @foreach ($product as $product)
                                    <option value="{{ $product->id }}" data-category-id="{{ $product->category_id }}"
                                        ...
                                        {{ $product->product_name ?? '' }},({{ $product->category->categoryName ?? '' }})
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <table class="table promotionTable">
                            ...
                            <tbody class="promotion-table-body">
                                @foreach ($promotionProduct as $promotionProduct)
                                    <tr>
                                        <td>
                                            <input value="{{ $promotionProduct->promotion_id }}" type="hidden"
                                                name="promotion_id[]">
                                            {{ $promotionProduct->coupon->promotion_name ?? '' }}
                                        </td>
                                        <td>
                                            <input value="{{ $promotionProduct->product_id }}" type="hidden"
                                                name="product_id[]">
                                        ...
                                        <td>
                                            @php
                                                $selectedVariants = App\Models\VariantPromotion::where(
                                                    'product_id',
                                            ...
                                            @if ($selectedVariants)
                                                <select class="form-select d-flex multiple-select variant-select"
                                                    name="variant_id[{{ $promotionProduct->product_id }}][]" multiple
                                        ...
                                        <td>
                                            ...
                                            <input value="{{ $promotionProduct->category_id }}" type="hidden"
                                                name="catgory_id[]">
                                            {{ $promotionProduct->category->categoryName ?? '--' }}
                                        </td>

                                        <td>

                                            <input value="{{ $promotionProduct->brand_id }}" type="hidden"
                                                name="brand_id[]">
                                            {{ $promotionProduct->brand->BrandName ?? '--' }}
                                        </td>


                                        <td><button class="btn btn-danger btn-sm remove-row delete_button"
                                                data-id="{{ $promotionProduct->id }}">Remove</button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".variant-select").on("change", function() {
                ...
                let allVariants = $(this).find("option").map(function() {
                    return this.value;
                }).get();
