            ...
            <div class="card border-top border-0 border-3 border-info col-md-8 offset-md-2">
                ...
                <div class="card-body">
                    <div class="card-title d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('product.promotion.create') }}"
                            class="btn btn-info btn-sm text-light get_product_and_promotion">
                            ...
                            <tbody id="">
                                @foreach ($productPromotion as $key => $promotionGroup)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $promotionGroup->product->product_name ?? '' }}
                                        </td>

                                        <td><a href="{{ route('product.promotion.view', $promotionGroup->promotion_id) }}"
                                                class="text-link">{{ $promotionGroup->coupon->promotion_name ?? 'N/A' }}</a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('admin.product.promotion.edit', $promotionGroup->promotion_id) }}"
                                                            class="dropdown-item edit">
                                                            Edit
                                                        </a>
                                                    </li>
                                                    <li><a href="#" class="dropdown-item delete"
                                                            data-id={{ $promotionGroup->promotion_id }}>Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
