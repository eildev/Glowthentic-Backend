                    ...
                    <div class="col-md-5 border-end">
                        ...
                        <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                            @foreach ($product->variantImage()->whereNull('deleted_at')->get() as $gallery)
                                <div class="col"><img src="{{ asset($gallery->image) }}" width="70"
                                ...
                                @foreach ($variants as $variant)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-success fw-semibold">
                                            ৳{{ number_format($variant->regular_price, 2) ?? 0 }}</td>
                                        <td>{{ $variant->size ?? '' }}</td>
                                        <td>
                                        ...
                                        <td>
                                            @foreach ($variant->variantImage as $image)
                                                <img src="{{ asset($image->image) }}" alt="Variant Image"
                                                    class="img-thumbnail rounded shadow-sm" width="50" height="50">
                                            @endforeach
                                        </td>
                                        <td class="fw-bold text-primary">{{ $variant->productStock->StockQuantity ?? 0 }}
                                        </td>
                                        <td>
                                            <span
                                                class="badge {{ $variant->status == 'active' ? 'bg-success' : 'bg-danger' }}">
