                        ...
                        <div class="col-12">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-12 col-md-3">
                                    ...
                                    <select class="form-select getdata shadow-sm" id="customUserSelect"
                                        name="custom_user_id">
                                        <option selected disabled value="">Choose...</option>
                                        @foreach ($custom_user as $user)
                                            <option value="{{ $user['id'] }}" data-source="{{ $user['source'] }}">
                                                {{ $user['name'] }}
                                                ({{ $user['source'] == 'user' ? 'Registered User' : 'Unlinked Detail' }})
                                            </option>
                                        @endforeach
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card shadow-sm p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="shippingInput" class="form-control" name="shipping_charge"
                                        value="0" min="0">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="discountInput" class="form-control" name="discount"
                                        value="0" min="0">
                                </div>
                                <hr>
                                <div class="mb-3">
        ...
        $(document).ready(function() {
            ...
            $('#paymentMethodSelect').on('change', function() {
                ...
                if (method === 'card') {
                    ...
                    $('input[name="card_number"], input[name="cvc_code"], input[name="card_expiry_date"]')
                        .prop('required', true);
                    $('input[name="mobile_banking_id"], input[name="verified_mobile_number"]').prop(
                        'required', false);
                ...
                if (id !== 'other' && id) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.user_data) {
                                $('input[name="full_name"]').val(data.user_data.name || data
                                    .user_data.full_name || '');
                                $('input[name="secondary_email"]').val(data.user_data.email ||
                                    data.user_data.secondary_email || '');
                                $('input[name="phone_number"]').val(data.user_data
                                    .phone_number || '');
                                ...
                                $('input[name="postal_code"]').val(data.user_data.postal_code ||
                                    '');
                                $('input[name="police_station"]').val(data.user_data
                                    .police_station || '');
            ...
            $('#orderForm').on('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            // console.log(xhr);
                            toastr.error('Failed to place order: ' + (xhr.responseJSON
