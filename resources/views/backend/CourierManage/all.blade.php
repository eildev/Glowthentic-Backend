            ...
            <div class="card mt-4 shadow-sm rounded">
                <div class="card-header bg-white">
                    <ul class="nav nav-tabs card-header-tabs" id="parcelTabs">
                        ...
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#approval">Approval Pending</a>
                        </li>
                                    ...
                                    <tbody>
                                        @foreach ($SteadfastStatus as $key => $SteadfastStatus)
                                            <tr>
                                                ...
                                                <td>{{ $SteadfastStatus->order->userDetails->full_name ?? 'N/A' }}</td>
                                                <td>{{ $SteadfastStatus->order->grand_total ?? '' }}</td>
                                                {{-- <td>৳50</td> --}}
                                                <td><span
                                                        class="badge bg-warning text-dark">{{ $SteadfastStatus->status ?? '' }}</span>
                                                </td>
