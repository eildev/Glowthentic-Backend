                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file" class="form-control @error('image') is-invalid  @enderror"
                                            id="image" name="image" value="{{ $feature->image }}">
                                        <div class="my-1">
                                            <i>
                                        ...
                                        @enderror
                                        <div class="mt-3">
                                            <img id="showImage" class="" height="150"
                                                src="/{{ $feature->image ?? 'uploads/productempty.jpg' }}"
                                                alt="Feature Image">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <a class="btn btn-info px-5" id="submitBtn">Update Feature</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            $("#submitBtn").on("click", function(e) {
                ...
                if (!$.isEmptyObject(errors)) {
                    ...
                    if (errors.feature_name) {
                        $("input[name='feature_name']").after(
                            `<span class="text-danger">${errors.feature_name}</span>`);
                    }
                    if (errors.image) {
