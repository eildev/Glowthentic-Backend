    ...
    <div class="container-fluid page-content py-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="card shadow h-100">
                    <div class="card-body">
                        <h6 class="card-title mb-3">Category Wise Product Stock</h6>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            $.ajax({
                ...
                error: function() {
                    alert("Something went wrong about to fetching category");
                }
            });
        });
